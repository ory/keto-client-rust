...
_Please note_: We take Ory Ory Keto Rust Client's security and our users' trust very
seriously. If you believe you have found a security issue in Ory Ory Keto Rust Client,
...
do this is via
[Ory Ory Keto Rust Client Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding Ory Ory Keto Rust Client?](#communication)
...
- I want to talk to other Ory Ory Keto Rust Client users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Ory Keto Rust Client.
...
- **Helping with open issues.** We have a lot of open issues for Ory Ory Keto Rust Client
...
Check out [Ory Ory Keto Rust Client Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory Ory Keto Rust Client,
...
before getting started to ensure your work is consistent with Ory Ory Keto Rust Client's
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Ory Keto Rust Client](https://github.com/ory/keto-client-rust/blob/master/.github/semantic.yml)
   for an overview.
...
[docs](https://github.com/ory/keto-client-rust/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/keto-client-rust/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Ory Keto Rust Client
