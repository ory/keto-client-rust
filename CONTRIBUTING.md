...
# Contribute to Ory Ory Keto Rust Client<!-- omit in toc -->
...
Ory Keto Rust Client's direction. A great way to
do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Ory Keto Rust Client and
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/keto-client-rust/blob/master/.github/workflows/conventional_commits.yml)
